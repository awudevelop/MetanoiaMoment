...
import { ArrowRight, Play, Globe, Users, Video, Sparkles, Clock } from 'lucide-react'
    ...
    <section className="section bg-warm-50">
      <div className="container">
        <AnimateOnScroll animation="fade-in-up" className="mb-8 text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-accent-100 px-4 py-1.5 text-sm font-medium text-accent-700 mb-4">
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-warm-50 via-primary-50/30 to-warm-50">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -right-20 -top-20 h-96 w-96 rounded-full bg-primary-100 opacity-50 blur-3xl animate-pulse-soft" />
        <div className="absolute -bottom-20 -left-20 h-96 w-96 rounded-full bg-accent-100 opacity-50 blur-3xl animate-pulse-soft" style={{ animationDelay: '1s' }} />
      </div>
      ...
      <div className="container relative">
        <div className="flex min-h-[80vh] flex-col items-center justify-center py-20 text-center">
          ...
          <AnimateOnScroll animation="fade-in-up" delay={200}>
            <p className="mt-6 max-w-2xl text-lg text-warm-600 md:text-xl">
              {t('subtitle')}
            </p>
          </AnimateOnScroll>
    ...
    <section className="section">
      <div className="container">
        <AnimateOnScroll animation="scale-in">
          <div className="mx-auto max-w-3xl rounded-2xl bg-gradient-to-br from-warm-100 to-primary-50 p-8 text-center md:p-12 transition-all duration-500 hover:shadow-xl">
            <h2 className="font-display text-3xl font-bold text-warm-900 md:text-4xl">
              {t('title')}
            </h2>
